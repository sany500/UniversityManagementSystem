                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#home" role="tab" aria-controls="profile" aria-selected="false">Create Result</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab"  href="/resultProcess" role="tab" aria-controls="profile" aria-selected="false">View Result</a>
                                    </li>

                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="d-flex justify-content-center"><h3>Create Result</h3></div>
                                        <div class="row">
                                            <section>
                                                ...
                                                <div class="form-row p-0 m-0">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6 p-0 m-0 p-3" id="formPersonal">
                                                        <form action="/resultInputSave" method="post">

                                                            <div class="form-group"><select class="ml-2 form-control" id="fName" name="facultyName">
                                                                    
                                                                        <option value="${map.user.userName}">${map.user.userName}</option>
                                                                    
                                                                </select></div>
                                                            <div class="form-group"><input class="form-control" type="text" name="sid"  placeholder="Student Id" id="sid"></div>
                                                            <div class="form-group"><input class="form-control" type="text" name="studentName" placeholder="Student Name" id="sname"></div>
                                                            <div class="form-group"><input class="form-control" type="text" name="semesterName" placeholder="Semester Name" id="semesterName"></div>
                                                            <div class="form-group"><input class="form-control" type="text" name="courseName" placeholder="Course Name" id="courseName"></div>
                                                            <div class="form-group"><input class="form-control" type="number" name="ct1" placeholder="Class Test 1"></div>
                                                            <div class="form-group"><input class="form-control" type="number" name="ct2" placeholder="Class Test 2"></div>
                                                            <div class="form-group"><input class="form-control" type="number" name="midterm" placeholder="Mid Term"></div>
                                                            <div class="form-group"><input class="form-control" type="number" name="final" placeholder="Final"></div>
                                                            <div class="form-group"><input class="form-control btn-primary" type="submit" value="Submit"></div>
                                                        </form>
                                                    </div>
                                                    <div class="col-lg-6 col-xl-6 p-0 m-0 p-3" id="formPersonal">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${map.asc}" var="stu">
                                                                    <tr>
                                                                        ...
                                                                        <td><button class="btn btn-primary" onclick="selectStudent('${stu.sid}', '${stu.name}', '${stu.semesterName}', '${stu.courseName}')">Select</button></td>
...
<script>
    function selectStudent(a, b, c, d) {
        $("#sid").val(a);
        $("#sname").val(b);
        $("#semesterName").val(c);
        $("#courseName").val(d);

                ...
                <div class="container my-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <div class="container-fluid">
                                <h3 class="text-dark mb-4">All Faculty</h3>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${map.faculties}" var="fa">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>${fa.religion}</td>
                                                                    <td>${fa.bloodGroup}</td>
                                                                    <td><a href="/fEdit/${fa.id}" ><button class="btn btn-info mb-1" ><i class="fa fa-edit" aria-hidden="true"></i></button></a>  <a href="/fDelete/${fa.id}" ><button class="btn btn-danger" id="delete1"><i class="fa fa-trash" aria-hidden="true"></i></button></a></td>
                        ...
                        <script>
                            $("#delete1").click(function () {
                                swal("", "Student Data Deleted Successfully", "success")
                            });
                        </script>
                        <!-- Grid column -->
                        <div class="col-xl-6">

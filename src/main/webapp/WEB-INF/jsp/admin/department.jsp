    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link active" href="/department"><i class="fas fa-address-card"></i><span>Department</span></a></li>
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Create Department</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                ...
                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                                                        ...
                                                        <script>
                                                            ...
                                                            function getDepartment() {
                                                                $.ajax({
                                                                    url: 'getUniversity/' + $("#select1 :selected").val(),
                                                                    type: 'GET',
                                                                    dataType: 'json',
                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div class="container-fluid">
                                            <h3 class="text-dark mb-4">All Departments</h3>
                                                            ...
                                                            <div class="table-responsive table-bordered table table-hover table-bordered results"
                                                                ...
                                                                <table class="table table-bordered table-hover">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <c:forEach items="${map.dList}" var="d">

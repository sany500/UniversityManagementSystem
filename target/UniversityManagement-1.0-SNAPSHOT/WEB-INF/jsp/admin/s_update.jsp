                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <div class="container-fluid">
                                <div class="container mt-5">
                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Update Student Details</h4></div>
                                    ...
                                    <form action="/sUpdate" method="post" id="measure-the-heat">
                                        <div class="form-row p-0 m-0">

                                            <div class="col-lg-6 col-xl-6 p-0 m-0 p-3" id="formPersonal">
                                                <input type="hidden"   name="id" value="${map.s.id}">
                                                <div class="form-group"><input class="form-control" type="text" name="sid" value="${map.s.sid}"></div>
                                                <div class="form-group"><input class="form-control" type="text" name="name" value="${map.s.name}"></div>
                                                <div class="form-group"><input class="form-control" type="email" name="email"  value="${map.s.email}"></div>
                                                <div class="form-group"><input class="form-control" type="tel" name="phone" value="${map.s.phone}"></div>
                                                <div class="form-group"><input class="form-control" type="text" name="address" value="${map.s.address}"></div>
                                                <!-- <div class="form-group"><input class="form-control" type="tel" required="" placeholder="LinkedIn"></div> -->
                                            </div>
                                            <div class="col-lg-6 col-xl-6 p-0 m-0 p-3" id="formPersonal">
                                                <div class="form-group"><input class="form-control" type="text" name="fname" value="${map.s.fName}"></div>

                                                <div class="form-group"><input class="form-control" type="text" name="mname" value="${map.s.mName}"></div>
                                                <div class="form-group"><input class="form-control" type="date" name="dob" value="${map.s.dob}"></div>
                                                <div class="form-group"><select class="form-control" name="religion" value="${map.s.religion}">
                                                ...
                                                <div class="form-group"><input class="form-control" type="text" name="bloodgroup"  value="${map.s.bloodGroup}"></div>
                                                <div class="col-lg-12 col-xl-12 d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="radio" id="male" name="gender" value="${map.s.gender}">
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="radio" id="female" name="gender" value="${map.s.gender}">
                                                    </div>
                                            ...
                                            <div class="col p-0 m-0 p-3 d-flex justify-content-end"><input class="btn btn-primary btn-block" id="update1" type="submit"  value="Update"/></div>
                                        </div>
                                    </form>

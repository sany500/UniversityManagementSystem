                ...
                <div class="container my-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                                                ...
                                                <div class="container mt-5">
                                                    ...
                                                    <form action="/save" method="post">
                                                        <div class="form-row p-0 m-0">
                                                            ...
                                                            <div class="col p-0 m-0 p-3 d-flex justify-content-end"><input class="btn btn-primary btn-block" type="submit" value="Submit" id="save"/></div>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <script>
                                $("#save").click(function () {
                                    swal("", "Student Data inserted Successfully", "success")
                                });
                            </script>

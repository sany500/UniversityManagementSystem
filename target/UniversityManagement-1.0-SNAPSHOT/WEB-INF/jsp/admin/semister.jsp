    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link active" href="/semister"><i class="fas fa-window-maximize"></i><span>Semester</span></a></li>
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Create Semester</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                                ...
                                                <div class="row justify-content-center ">
                                                    <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                                                        ...
                                                        <form action="/semisterSave" method="post">
                                                            ...
                                                            <div class="form-group"><input class="form-control" type="text" name="semesterCode" placeholder="Semester Code"></div>
                                                            <div class="form-group"><input class="form-control" type="text" name="semesterName" placeholder="Semester Name"></div>
                                                        ...
                                                        <script>
                                                            ...
                                                            function getUniversity() {
                                                                $.ajax({
                                                                    url: 'getDepartment/' + $("#select1 :selected").val(),
                                                                    type: 'GET',
                                                                    dataType: 'json',
                                                            ...
                                                            <div class="table-responsive table-bordered table table-hover table-bordered results"
                                                                ...
                                                                <table class="table table-bordered table-hover">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <c:forEach items="${map.semesters}" var="d">
